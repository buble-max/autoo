...
akbarvpnn="raw.githubusercontent.com/buble-max/autoo/master/sstp"
# Link Hosting Kalian Untuk Ssr
akbarvpnnn="raw.githubusercontent.com/buble-max/autoo/master/ssr"
# Link Hosting Kalian Untuk Shadowsocks
akbarvpnnnn="raw.githubusercontent.com/buble-max/autoo/master/shadowsocks"
# Link Hosting Kalian Untuk Wireguard
akbarvpnnnnn="raw.githubusercontent.com/buble-max/autoo/master/wireguard"
# Link Hosting Kalian Untuk Xray
akbarvpnnnnnn="raw.githubusercontent.com/buble-max/autoo/master/xray"
# Link Hosting Kalian Untuk Ipsec
akbarvpnnnnnnn="raw.githubusercontent.com/buble-max/autoo/master/ipsec"
# Link Hosting Kalian Untuk Backup
akbarvpnnnnnnnn="raw.githubusercontent.com/buble-max/autoo/master/backup"
# Link Hosting Kalian Untuk Websocket
akbarvpnnnnnnnnn="raw.githubusercontent.com/buble-max/autoo/master/websocket"
# Link Hosting Kalian Untuk Ohp
akbarvpnnnnnnnnnn="raw.githubusercontent.com/buble-max/autoo/master/ohp"


# Getting
echo -e ""
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e "\E[44;1;39m          ⇱ SCRIPT BY MASSBROW ⇲          \E[0m"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e ""
...
# Install SlowDNS
wget https://raw.githubusercontent.com/buble-max/autoo/master/SLDNS/install-sldns && chmod +x install-sldns && ./install-sldns
# Informasi IP Saya dan Semua Port TCP UDP
# wget https://raw.githubusercontent.com/buble-max/autoo/master/ipsaya.sh && chmod +x ipsaya.sh
#
# install xray sl-grpc
# wget https://raw.githubusercontent.com/buble-max/autoo/master/grpc/sl-grpc.sh && chmod +x sl-grpc.sh && screen -S sl-grpc ./sl-grpc.sh
# install xray grpc
# wget https://raw.githubusercontent.com/buble-max/autoo/master/grpc/xray-grpc.sh && chmod +x xray-grpc.sh && screen -S xray-grpc ./xray-grpc.sh
# install shadowsocks plugin
# wget https://raw.githubusercontent.com/buble-max/autoo/master/shadowsocks-plugin/install-ss-plugin.sh && chmod +x install-ss-plugin.sh && ./install-ss-plugin.sh
...
cat <<EOF> /etc/systemd/system/autoot.service
[Unit]
Description=autooting
...
echo "----------------------------------------------------------------------------" | tee -a log-install.txt
echo "   -                CREATED : MASSWBRO" | tee -a log-install.txt
