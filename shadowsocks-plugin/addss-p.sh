...
echo -e "Link Application v2ray-plugin: #://$MYIP:89/xray-plugin-universal.apk"
echo -e "Link Application gost-plugin: #://$MYIP:89/gost-plugin-x86.zip"
echo -e "Link Application gost-plugin: #://$MYIP:89/gost-plugin-arm.zip"
echo -e "Link Application xray-plugin: #://$MYIP:89/v2ray-plugin-universal.apk"
echo -e "change the # sign to http"
echo -e "========================="
