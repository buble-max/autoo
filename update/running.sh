...
#Name=$(curl -sS https://raw.githubusercontent.com/givpn/izin/master/autoo | grep $MYIP | awk '{print $2}')
#Exp2=$(curl -sS https://raw.githubusercontent.com/givpn/izin/master/autoo | grep $MYIP | awk '{print $3}')
Exp2=$"Lifetime"
Name=$"Rifki"
red='\e[1;31m'
green='\e[1;32m'
